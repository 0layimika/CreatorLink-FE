  ...
  return (
    <div className="w-full h-screen bg-black relative overflow-hidden">
      <Canvas camera={{ position: [0, 0, 3], fov: 50 }}>
        ...
        <ShaderPlane position={[-0.7, 0.2, 0]} color1="#ff5722" color2="#1a1a1a" />
        <ShaderPlane position={[0.8, -0.2, -0.2]} color1="#7c3aed" color2="#0d1117" />
        <EnergyRing radius={0.85} position={[0.3, 0.1, 0.2]} />
      </Canvas>
