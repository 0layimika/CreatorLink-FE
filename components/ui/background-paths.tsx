    ...
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-background">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
        ...
        >
          ...
          <div className="inline-block group relative p-px rounded-2xl backdrop-blur-lg overflow-hidden border border-border">
            <Button
              variant="ghost"
              className="rounded-[1.15rem] px-8 py-6 text-lg font-semibold bg-card hover:bg-card/90 text-foreground border border-border"
            >
