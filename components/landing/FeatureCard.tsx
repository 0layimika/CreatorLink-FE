...
export function FeatureCard({ feature, index }: FeatureCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative surface-panel backdrop-blur-sm hover:border-border rounded-2xl p-8 h-full transition-all duration-300 hover:shadow-medium group-hover:-translate-y-1">
